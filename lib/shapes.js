...
class Shapes {
    ...
    // render function generates the svg depending on constructor input
    render() {
...
// all shape extensions have their own insertShape to dictate their shape when generated - this is inserted into the render function
